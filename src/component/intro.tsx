...
function Intro() {
  return (
    <div
      className="relative xl:flex-1 w-full h-[40%] xl:h-auto bg-cover bg-center"
    ...
    >
      <div className="absolute bottom-0 pb-6 left-0 pl-10 xl:pl-24 xl:py-36">
        ...
        <p className="xl:text-5xl py-1 sm:text-3xl text-2xl text-stroke text-shadow-custom">
          HELLO, I’M
        </p>
        <p className="xl:text-8xl py-2 sm:text-6xl text-5xl text-stroke text-shadow-custom">
          Bhuwadol Sriton
        </p>
        <p className="xl:text-5xl py-1 sm:text-3xl text-2xl text-stroke text-shadow-custom">
          Computer Engineering Student.
